...
# - All the compressions are stored in a backup dir in your HOME directory. (~/backups/monthly/)
...
# ---
# ./monthly.backup.sh "/home/user/web-app" "user@198.168.1.0"
# ---
#
# (2) If you wish to backup multiple files same as the above step but add whitespaces as seperator still withing the string.
# ---
# ./monthly.backup.sh "/home/user/web-app /home/user/Videos /tmp/my-temp-files" "user@198.168.1.0"
# ---
